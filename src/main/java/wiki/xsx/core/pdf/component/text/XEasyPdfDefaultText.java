 ...
 * </p>
 */
public class XEasyPdfDefaultText implements XEasyPdfText, XEasyPdfComponentBuilder {
     ...
     * @param text 待输入文本
     */
    public XEasyPdfDefaultText(String fontPath, String text) {
     ...
     * @param text 待输入文本
     */
    public XEasyPdfDefaultText(String fontPath, float fontSize, String text) {
     ...
     * @param text 待输入文本
     */
    public XEasyPdfDefaultText(String fontPath, float fontSize, float beginX, float beginY, String text) {
     ...
     * @param text 待输入文本
     */
    public XEasyPdfDefaultText(String fontPath, float fontSize, float leading, float beginX, float beginY, String text) {
     ...
     * @param param 文本参数
     */
    public XEasyPdfDefaultText(XEasyPdfTextParam param) {
        if (param==null) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setMargin(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setMarginLeft(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setMarginRight(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setMarginTop(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setMarginBottom(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setPosition(float x, float y) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setLeading(float leading) {
        if (leading>0) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setFont(String fontPath) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setFontSize(float fontSize) {
     ...
     */
    @Override
    public XEasyPdfDefaultText setStyle(XEasyPdfTextStyle style) {
