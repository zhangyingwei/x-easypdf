 ...
 * </p>
 */
public class XEasyPdfDefaultSolidSplitLine implements XEasyPdfSolidSplitLine, XEasyPdfComponentBuilder {
     ...
     * 无参构造
     */
    public XEasyPdfDefaultSolidSplitLine() {}

    /**
     * 有参构造
     * @param fontPath 字体路径
     */
    public XEasyPdfDefaultSolidSplitLine(String fontPath) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setMargin(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setMarginLeft(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setMarginRight(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setMarginTop(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setMarginBottom(float margin) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setLineWidth(float lineWidth) {
     ...
     */
    @Override
    public XEasyPdfDefaultSolidSplitLine setLineCapStyle(XEasyPdfLineCapStyle lineCapStyle) {
    ...
    public void draw(XEasyPdfDocument document, XEasyPdfPage page) throws IOException {
        ...
        // 执行画图
        new XEasyPdfDefaultLine(this.param).draw(document, page);
