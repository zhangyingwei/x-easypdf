...
public class XEasyPdfSimpleTable implements XEasyPdfComponent {
     ...
     * @return 返回表格组件
     */
    public XEasyPdfSimpleTable setDefaultFontStyle(XEasyPdfDefaultFontStyle style) {
     ...
     * @return 返回表格组件
     */
    public XEasyPdfSimpleTable setHorizontalStyle(XEasyPdfTableStyle style) {
        if (style!=null) {
     ...
     * @return 返回表格组件
     */
    public XEasyPdfSimpleTable setVerticalStyle(XEasyPdfTableStyle style) {
        if (style!=null) {
